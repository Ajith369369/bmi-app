...
const BMIResult = ({ bmi }) => {
  ...
  if (bmi < 18.5) {
    ...
    message = "You are overweight. Consider managing your weight for better health.";
  } else {
    category = "Obese";
    backgroundColor = "red";
    message = "You are obese. It's important to work on reducing your weight for health benefits.";
  }
